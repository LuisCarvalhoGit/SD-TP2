...
class AnalysisServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AnalyzeData = channel.unary_unary(
                '/urbanhealth.AnalysisService/AnalyzeData',
...
def add_AnalysisServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'urbanhealth.AnalysisService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('urbanhealth.AnalysisService', rpc_method_handlers)
